    ...
    <>
      <nav className="justify-between bg-background font-poppins flex flex-row items-center  ${isActive('/')} ">
        ...
        <div className="options gap-6 text-text wb:flex hidden">
          <Link to="/developers" className={`${isActive("/developers")} hover:text-primary transition`}>
            Developers
          </Link>
          <Link to="/ecosystem" className={`${isActive("/ecosystem")} hover:text-primary transition`}>
            Ecosystem
          </Link>
          <Link to="/community" className={`${isActive("/community")}  hover:text-primary transition`} hover>
            Community
          </Link>
          <Link to="/dapps" className={`${isActive("/dapps")}  hover:text-primary transition`}>
            DApps
          </Link>
          <Link to="/roadmap" className={`${isActive("/roadmap")}  hover:text-primary transition`}>
            Roadmap
          </Link>
          <Link to="/resources" className={`${isActive("/resources")} hover:text-primary transition`}>
            Resource
          </Link>
          <Link to="/test" className={`${isActive("/test")}  hover:text-primary transition`}>
            Test
          </Link>
        </div>
